  ...
  var l = {
    ...
    gestures: function () {
      ...
      function c(a) {
        ...
        d.dragDirection =
          0 > d.newRelativeX ? (d.owl.dragDirection = "left") : (d.owl.dragDirection = "right");
        0 !== d.newRelativeX &&
          ((c = d.getNewPosition()),
          d.goTo(c, !1, "drag"),
    ...
    closestItem: function () {
      ...
      f.each(b, function (d, g) {
        e - a.itemWidth / 20 > b[d + 1] && e - a.itemWidth / 20 < g && "left" === a.moveDirection()
          ? ((c = g),
            (a.currentItem = !0 === a.options.scrollPerPage ? f.inArray(c, a.positionsInArray) : d))
          : e + a.itemWidth / 20 < g &&
